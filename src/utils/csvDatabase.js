// CSV "database": file at data/DB.csv. קריאה בדפדפן ובשרת; כתיבה לדיסק מ־`csvDatabaseWrite.server.js` (GET `/api/ynet`, `/api/maariv`, `/api/walla`, `/api/israelhayom`, `/api/hurriyet` או `/api/jordantimes`).
