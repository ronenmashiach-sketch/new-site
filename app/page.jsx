...
export default function Dashboard() {
  ...
  // Fetch news from RSS/API. DB.csv מתעדכן מ־`/api/ynet`, `/api/maariv`, `/api/walla`, `/api/israelhayom`, `/api/hurriyet`, `/api/jordantimes`, `/api/ahram`, `/api/aawsat`, `/api/national` (לא מהדף).
