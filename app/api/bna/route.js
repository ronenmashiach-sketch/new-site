...
import { BNA_HOME_URL, buildBnaNewsPayload } from '@/utils/bnaNewsPayload';
...
/**
 * GET /api/bna — Homepage hero (best-effort) + RSS flashers (אם מסופק) + תרגום.
        ...
        return Response.json(
          {
            ...
            fetchError,
            hint: 'האתר לעיתים חסום עם Human Verification. נסה ?useDbFallback=1 (DB.csv) או ספק rssUrl חוקי אם יש.',
          },
